...
class Dashboard_Activator {
    ...
    private static function migrate_settings() {
        // Core info migration (from Workedia or older)
        $workedia_info = get_option('workedia_info');
        if ($workedia_info && !get_option('dashboard_info')) {
             $mapped_info = [];
             foreach ((array)$workedia_info as $key => $value) {
                 $new_key = str_replace('workedia_', 'dashboard_', $key);
    ...
    private static function migrate_tables() {
        global $wpdb;
        // Rebranding Migration (workedia_ -> dashboard_)
        $mappings_workedia = array(
            'workedia_members'                => 'dashboard_members',
            'workedia_messages'               => 'dashboard_messages',
            'workedia_logs'                   => 'dashboard_logs',
            'workedia_notification_templates' => 'dashboard_notification_templates',
            'workedia_notification_logs'      => 'dashboard_notification_logs',
            'workedia_tickets'                => 'dashboard_tickets',
            'workedia_ticket_thread'          => 'dashboard_ticket_thread',
            'workedia_pages'                  => 'dashboard_pages',
            'workedia_articles'               => 'dashboard_articles',
            'workedia_alerts'                 => 'dashboard_alerts',
            'workedia_alert_views'            => 'dashboard_alert_views'
        );

        foreach ($mappings_workedia as $old => $new) {
    ...
    private static function migrate_user_meta() {
        global $wpdb;
        $meta_mappings = [
            'workedia_phone' => 'dashboard_phone',
            'workedia_account_status' => 'dashboard_account_status',
            'workedia_temp_pass' => 'dashboard_temp_pass',
            'workedia_recovery_otp' => 'dashboard_recovery_otp',
            'workedia_recovery_otp_time' => 'dashboard_recovery_otp_time',
            'workedia_recovery_otp_used' => 'dashboard_recovery_otp_used',
